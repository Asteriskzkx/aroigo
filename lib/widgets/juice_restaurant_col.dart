import 'package:aroigo/data/juice_restaurant.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class JuiceRestaurantCol extends StatefulWidget {
  const JuiceRestaurantCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _JuiceRestaurantCol();
  }
}

class _JuiceRestaurantCol extends State<JuiceRestaurantCol> {
  final List<RestaurantModel> restaurant = JuiceRestaurant.getRestaurants();
