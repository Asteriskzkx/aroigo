import 'package:aroigo/data/rice_bowls_restaurant.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class RiceBowlsRestaurantcardCol extends StatefulWidget {
  const RiceBowlsRestaurantcardCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _RiceBowlsRestaurantcardCol();
  }
}

class _RiceBowlsRestaurantcardCol extends State<RiceBowlsRestaurantcardCol> {
  final List<RestaurantModel> restaurant = RiceBowlsRestaurant.getRestaurants();
