import 'package:aroigo/data/noodle_restaurant.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class NoodleRestaurantCol extends StatefulWidget {
  const NoodleRestaurantCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _NoodleRestaurantCol();
  }
}

class _NoodleRestaurantCol extends State<NoodleRestaurantCol> {
  final List<RestaurantModel> restaurant = NoodleRestaurant.getRestaurants();
