import 'package:aroigo/data/coffee_and_tea_shop.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class CoffeeAndTeaShopCol extends StatefulWidget {
  const CoffeeAndTeaShopCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _CoffeeAndTeaShopCol();
  }
}

class _CoffeeAndTeaShopCol extends State<CoffeeAndTeaShopCol> {
  final List<RestaurantModel> restaurant = CoffeeAndTeaShop.getRestaurants();
