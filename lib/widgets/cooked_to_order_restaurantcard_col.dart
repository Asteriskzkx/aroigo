import 'package:aroigo/data/cooked_to_order_restaurant.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class CookedToOrderRestaurantcardCol extends StatefulWidget {
  const CookedToOrderRestaurantcardCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _CookedToOrderRestaurantcardCol();
  }
}

class _CookedToOrderRestaurantcardCol
    extends State<CookedToOrderRestaurantcardCol> {
  final List<RestaurantModel> restaurant =
      CookedToOrderRestaurant.getRestaurants();
