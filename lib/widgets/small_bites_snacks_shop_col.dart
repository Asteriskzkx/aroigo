import 'package:aroigo/data/small_bites_snacks_shop.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class SmallBitesSnacksShopCol extends StatefulWidget {
  const SmallBitesSnacksShopCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _SmallBitesSnacksShopCol();
  }
}

class _SmallBitesSnacksShopCol extends State<SmallBitesSnacksShopCol> {
  final List<RestaurantModel> restaurant =
      SmallBitesSnacksShop.getRestaurants();
