import 'package:aroigo/data/fast_food_restaurant.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class FastFoodRestaurantCol extends StatefulWidget {
  const FastFoodRestaurantCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _FastFoodRestaurantCol();
  }
}

class _FastFoodRestaurantCol extends State<FastFoodRestaurantCol> {
  final List<RestaurantModel> restaurant = FastFoodRestaurant.getRestaurants();
