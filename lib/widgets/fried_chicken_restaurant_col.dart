import 'package:aroigo/data/fried_chicken_restaurant.dart';
import 'package:aroigo/model/restaurant_model.dart';
import 'package:aroigo/screens/restaurantscreen.dart';
import 'package:flutter/material.dart';

class FriedChickenRestaurantCol extends StatefulWidget {
  const FriedChickenRestaurantCol({super.key});

  @override
  State<StatefulWidget> createState() {
    return _FriedChickenRestaurantCol();
  }
}

class _FriedChickenRestaurantCol extends State<FriedChickenRestaurantCol> {
  final List<RestaurantModel> restaurant =
      FriedChickenRestaurant.getRestaurants();
